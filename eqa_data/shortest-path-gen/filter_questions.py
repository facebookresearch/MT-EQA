...
bad_object_list = []
Entropy_Threshold = 0.90  # all v2 questions are just yes/no, we need to have a more strict entropy threshold
Count_Threshold = 2
...
def main(args):
  """
  When I was writing this code, the ``generate-shortest-paths-v2'' is still running, also take
  the missing sampled path json files into consideration.
  """
  # set seed
  ...
  # save
  output_question_json = osp.join(args.output_dir, 'questions_v2_paths_'+args.sample_mode+'.json')
...
if __name__ == '__main__':
  ...
  parser.add_argument('--input_question_json', default='cache/question-gen-outputs/questions_pruned_v2_with_conn.json')
